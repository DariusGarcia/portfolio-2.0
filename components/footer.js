				...
				<nav
					...
					{navigation.main.map((item) => (
						<div key={item.name} className='px-5 py-2'>
							<Link href={item.href}>
								<a className='text-base text-darkGrey hover:text-white hover:bg-blue3  p-3 hover:shadow-xl hover:scale-110 transition ease-in-out delay-50 rounded-lg items-none'>
									{item.name}
								</a>
							</Link>
						</div>

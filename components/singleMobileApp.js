...
export default function SingleProject({
  ...
  return (
    <m.article
      ...
      id={name}
      key={name}
      className='relative mb-4 md:mb-0 min-h-96 h-max p-4 border-[1px] overflow-hidden hover:border-blue3 text-white border-darkGrey rounded-md transition ease-in-out delay-110 shadow-xl'
    >
      {!open ? (
        ...
        <m.div variants={cardVariants} className='flex flex-col cursor-text '>
